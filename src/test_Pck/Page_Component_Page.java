...
public class Page_Component_Page {
...
public static void main(String[] args) {
	    ...
	    driver.findElement(By.xpath("//a[@href='#/importdata']")).click();
	    
	    
	    WebElement upload_file = driver. findElement(By. xpath("//input[@accept='all/*']"));
	    
	    upload_file. sendKeys("C:\\Users\\RohitFulzele\\Downloads\\InvestmentPosition (20).csv");
	    
	  
	   // driver.findElement(By.xpath("//input[@accept='all/*']")).click();	
     ...
     //   driver.findElement(By.xpath("//input[@formcontrolname='name_en']")).sendKeys("test");
